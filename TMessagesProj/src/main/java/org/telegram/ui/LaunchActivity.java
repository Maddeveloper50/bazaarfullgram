...
import org.Supergram.ui.ActionBar.DrawerLayoutContainer;
import org.Supergram.ui.Components.EmbedBottomSheet;
import org.Supergram.ui.Components.JoinGroupAlert;
import org.Supergram.ui.Components.LayoutHelper;
import org.Supergram.ui.Components.PasscodeView;
        ...
        sideMenu.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (position == 0) {
                    ...
                    Browser.openUrl(LaunchActivity.this, LocaleController.getString("SupergramFaqUrl", R.string.SupergramFaqUrl));
                    drawerLayoutContainer.closeDrawer(false);
                } else if (id == 10) {
                        ...
                        if (data != null) {
                            ...
                            if (scheme != null) {
                                if ((scheme.equals("http") || scheme.equals("https"))) {
                                    ...
                                    if (host.equals("Supergram.me") || host.equals("t.me") || host.equals("Supergram.dog")) {
                                    ...
                                    if (url.startsWith("tg:resolve") || url.startsWith("tg://resolve")) {
                                        url = url.replace("tg:resolve", "tg://Supergram.org").replace("tg://resolve", "tg://Supergram.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:join", "tg://Supergram.org").replace("tg://join", "tg://Supergram.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://Supergram.org").replace("tg://addstickers", "tg://Supergram.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://Supergram.org").replace("tg://msg", "tg://Supergram.org").replace("tg://share", "tg://Supergram.org").replace("tg:share", "tg://Supergram.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
