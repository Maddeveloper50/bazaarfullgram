...
import org.Supergram.ui.Cells.AboutLinkCell;
...
import org.Supergram.ui.Cells.TextCell;
import org.Supergram.ui.Cells.TextDetailCell;
import org.Supergram.ui.Cells.TextInfoPrivacyCell;
import org.Supergram.ui.Cells.UserCell;
...
import org.Supergram.ui.Components.IdenticonDrawable;
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow || position == channelNameRow) {
            ...
            if (MessagesController.getInstance().callsEnabled && userFull != null && userFull.phone_calls_available) {
                items.add(LocaleController.getString("CallViaSupergram", R.string.CallViaSupergram));
                actions.add(2);
            }
