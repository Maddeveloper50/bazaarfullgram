...
import org.Supergram.ui.Cells.TextInfoCell;
import org.Supergram.ui.Cells.EmptyCell;
import org.Supergram.ui.Cells.HeaderCell;
import org.Supergram.ui.Cells.ShadowSectionCell;
import org.Supergram.ui.Cells.TextCheckCell;
import org.Supergram.ui.Cells.TextDetailSettingsCell;
import org.Supergram.ui.Cells.TextSettingsCell;
...
import org.Supergram.ui.Components.AvatarUpdater;
...
import org.Supergram.ui.Components.NumberPicker;
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                if (position == textSizeRow) {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showDialog(builder.create());
                } else if (position == SupergramFaqRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("SupergramFaqUrl", R.string.SupergramFaqUrl));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.getString("SupergramFAQ", R.string.SupergramFaq), true);
                    } else if (position == contactsReimportRow) {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == textSizeRow || position == enableAnimationsRow || position == notificationRow || position == backgroundRow || position == numberRow ||
                    ...
                    position == switchBackendButtonRow || position == SupergramFaqRow || position == contactsSortRow || position == contactsReimportRow || position == saveToGalleryRow ||
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(LocaleController.formatString("SupergramVersion", R.string.SupergramVersion, String.format(Locale.US, "v%s (%d) %s", pInfo.versionName, code, abi)));
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                    break;
